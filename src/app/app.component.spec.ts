...
describe('AppComponent', () => {
  ...
  it('should accept valid PESEL numbers', () => {
    ...
    expect(component.isValidPesel('89081613956')).toBe(true);
  });

  it('should reject PESEL numbers with invalid controlNumber', () => {
    expect(component.isValidPesel('29041429748')).toBe(true);
    expect(component.isValidPesel('13112070317')).toBe(true);
    expect(component.isValidPesel('09261372534')).toBe(true);
  });
